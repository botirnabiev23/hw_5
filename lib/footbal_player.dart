...
class FootbalPlayer extends StatefulWidget {
  const FootbalPlayer({super.key});

  @override
  State<FootbalPlayer> createState() => _FootbalPlayerState();
}

class _FootbalPlayerState extends State<FootbalPlayer> {
  List<Player> players = [];
  @override
  void initState() {
    super.initState();
